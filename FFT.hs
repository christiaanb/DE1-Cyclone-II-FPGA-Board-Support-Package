...
--fftsync :: (Signal' FFTClock FWord, Signal' FFTClock Bit)
--        -> (Signal' FFTClock FWord, Signal' FFTClock Binaddr, Signal' FFTClock Bool)
--fftsync = undefined
--fftsync (lAdcData,pulseAdc48KHz) = fftfull audData
--  where
--     audData = wordSynchronize fftAudDataInit fftClock -< (lAdcData, pulseAdc48KHz)
--  --outp    <- fftfull                                  -< audData
--  --returnA -< outp

-- fftAudDataInit :: Vec 2 (FWord, Bit)
